...
### 10. Macro Event Universal Penalty Enforcement
*   **The Anti-Pattern**: Applying sector-specific discounts (such as a 0.3x penalty reduction) to market-wide macro events (like the Union Budget) for "non-sensitive" sectors. This under-penalizes massive tail-risk events on stocks that still experience extreme volatility, IV crush, and gap risks on those days.
*   **The Rule**: Ensure market-wide macro events (like the Union Budget) apply their full, universal penalty across all stocks regardless of sector. Sector-aware sensitivity lists must be reserved exclusively for events with genuine, isolated sectoral impact (e.g., RBI interest rate policy affecting financial firms).
